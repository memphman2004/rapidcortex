...
for key in \
  ...
  NEXT_PUBLIC_ENABLE_LIVE_VIDEO NEXT_PUBLIC_ENABLE_CAD_ADMIN NEXT_PUBLIC_ENABLE_CAD_BRIDGE \
  NEXT_PUBLIC_ENABLE_CAD_WRITEBACK NEXT_PUBLIC_ENABLE_CAD_CONNECTOR \
