...
# Scenario Center stays off unless you opt in for QA (never on live DeploymentStage=dev).
export ENABLE_SCENARIO_API=false
...
export ENABLE_SOP_INTELLIGENCE=true
export ENABLE_NON_EMERGENCY_TRIAGE=true
export ENABLE_NG911_ASSIST=true
export NG911_DIVERSION_MOCK_SMS=true
export ENABLE_CALL_ASSIST=true
export ENABLE_CALL_ASSIST_GREETING_CONFIG=true
...
export ENABLE_RAPID_VISION_TRANSCRIPT=true
export ENABLE_VISION_AI=true
export ENABLE_VISION_AI_CLAUDE=true
export ENABLE_VISION_AI_THUMBNAILS=true
export ENABLE_VISION_AI_WS=true
export ENABLE_VISION_AI_ADMIN=true
export VISION_AI_MOCK=true
export ENABLE_CALL_ASSIST_CAD_PUSH=false
...
export NEXT_PUBLIC_ENABLE_CALL_ASSIST_GREETING_CONFIG="${NEXT_PUBLIC_ENABLE_CALL_ASSIST_GREETING_CONFIG:-1}"
export NEXT_PUBLIC_ENABLE_RC_TRANSLATE="${NEXT_PUBLIC_ENABLE_RC_TRANSLATE:-1}"
export NEXT_PUBLIC_ENABLE_RC_TRANSLATE_VENUE="${NEXT_PUBLIC_ENABLE_RC_TRANSLATE_VENUE:-1}"
...
export NEXT_PUBLIC_ENABLE_RAPID_VISION_TRANSCRIPT="${NEXT_PUBLIC_ENABLE_RAPID_VISION_TRANSCRIPT:-1}"
export NEXT_PUBLIC_ENABLE_VISION_AI="${NEXT_PUBLIC_ENABLE_VISION_AI:-1}"
export NEXT_PUBLIC_ENABLE_VISION_AI_CLAUDE="${NEXT_PUBLIC_ENABLE_VISION_AI_CLAUDE:-1}"
export NEXT_PUBLIC_ENABLE_VISION_AI_THUMBNAILS="${NEXT_PUBLIC_ENABLE_VISION_AI_THUMBNAILS:-1}"
export NEXT_PUBLIC_ENABLE_VISION_AI_WS="${NEXT_PUBLIC_ENABLE_VISION_AI_WS:-1}"
export NEXT_PUBLIC_ENABLE_VISION_AI_ADMIN="${NEXT_PUBLIC_ENABLE_VISION_AI_ADMIN:-1}"
export NEXT_PUBLIC_ENABLE_RC_VIDEO="${NEXT_PUBLIC_ENABLE_RC_VIDEO:-1}"
export ENABLE_RC_VIDEO=true
export ENABLE_RC_VIDEO_ATTACH_STORAGE=false
export VIDEO_GATEWAY_URL="${VIDEO_GATEWAY_URL:-}"
export VIDEO_GATEWAY_SECRET_ARN="${VIDEO_GATEWAY_SECRET_ARN:-}"
# Rekognition stream analytics — opt-in cost gate (default off).
export ENABLE_RC_VIDEO_ANALYTICS=false
...
export ENABLE_TRANSIT_CAMERAS=true
export NEXT_PUBLIC_ENABLE_TRANSIT_CAMERAS="${NEXT_PUBLIC_ENABLE_TRANSIT_CAMERAS:-1}"
# Multi-CAD Connector — fail-closed. Do not set true until the nested CAD stack is deployed and the addon is entitled.
export ENABLE_CAD_CONNECTOR="${ENABLE_CAD_CONNECTOR:-false}"
export NEXT_PUBLIC_ENABLE_CAD_CONNECTOR="${NEXT_PUBLIC_ENABLE_CAD_CONNECTOR:-0}"
export CAD_CONNECTOR_MOCK="${CAD_CONNECTOR_MOCK:-false}"
export ENABLE_EMERGENCY_CONNECT=true
export ENABLE_HOSPITAL_ROUTING=true
export NEXT_PUBLIC_ENABLE_VERTICAL_TRANSIT="${NEXT_PUBLIC_ENABLE_VERTICAL_TRANSIT:-1}"
...
export OPENAI_WEB_SEARCH_ENABLED="${OPENAI_WEB_SEARCH_ENABLED:-false}"
export RAPIDIQ_MODEL_CLASSIFICATION="${RAPIDIQ_MODEL_CLASSIFICATION:-gpt-4o-mini}"
export RAPIDIQ_MODEL_ANALYSIS="${RAPIDIQ_MODEL_ANALYSIS:-gpt-4o}"
export RAPIDIQ_MODEL_STRATEGY="${RAPIDIQ_MODEL_STRATEGY:-gpt-4o}"
...
export ENABLE_AUTOMATED_INVOICES=true
export AUTO_SEND_INVOICES=false
export NEXT_PUBLIC_ENABLE_AUTOMATED_INVOICES="${NEXT_PUBLIC_ENABLE_AUTOMATED_INVOICES:-1}"
