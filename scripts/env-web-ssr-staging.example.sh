...
export NEXT_PUBLIC_ENABLE_GUEST_ASSIST="${NEXT_PUBLIC_ENABLE_GUEST_ASSIST:-1}"
# Guest Assist staff WebSocket HMAC — must match AppSamRealtime2Stack GuestAssistSessionSecret
