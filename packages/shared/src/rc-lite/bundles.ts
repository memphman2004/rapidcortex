 ...
 * Each bundle maps to API scopes (NexCort Lite) and internal commercial packaging.
 */
...
export const RC_LITE_PRODUCT_BUNDLES: readonly RcLiteProductBundle[] = [
  ...
  },
  {
    ...
    label: "NexCort Lite Caller Media",
