...
/** First URL segment for NexCort iQ operational web apps (not marketing, not NexCort Lite console). */
...
/** Cross-tenant NexCort Admin console mounted at `/rc-admin`. */
 ...
 * Used to align tests with Next.js middleware behavior for NexCort Lite vs NexCort iQ platform.
 */
