...
const VIDEO_RECORDING: readonly Permission[] = ["video.recording.configure"];
const VIDEO_PTZ: readonly Permission[] = ["video.ptz.control"];
...
export const CAMPUS_ROLE_PERMISSIONS: Record<CampusRole, string[]> = {
  CAMPUS_ADMIN: [
    ...
    "clery.record.create",
    "clery.record.review",
    "clery.record.unfound",
    "clery.daily-crime-log.view",
    "clery.daily-crime-log.manage",
    "clery.asr.view",
    "clery.asr.generate",
    "clery.asr.approve",
    "clery.zones.configure",
    "clery.csa.manage",
    "clery.compliance.view",
    "campus.eap.view",
    "campus.eap.manage",
    "campus.staff.manage",
    "alerts.recipients.manage",
    "alerts.templates.manage",
    "alerts.dispatch",
  ...
  CAMPUS_FACULTY: ["campus.dashboard.view", "campus.reports.view", "alerts.history.view"],
};
