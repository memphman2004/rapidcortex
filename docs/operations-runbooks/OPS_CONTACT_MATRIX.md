...
NexCort iQ platform rows filled 2026-09-19 (interim combined owner). Detail: [soc2/evidence/2026-09-19-prewindow/02-owners.md](../security-compliance/soc2/evidence/2026-09-19-prewindow/02-owners.md).
...
| NexCort iQ pilot lead | Jeff Coleman | `support@nexcortiq.us` | off-git | US Eastern | none yet (R-SOC-015) |
| NexCort iQ on-call / paging bridge | Jeff Coleman | `support@nexcortiq.us` + SNS OpsAlerts | off-git | Business hours + best-effort | none yet |
...
| Security / privacy | Jeff Coleman | `privacy@nexcortiq.us` | off-git | US Eastern | none yet |
