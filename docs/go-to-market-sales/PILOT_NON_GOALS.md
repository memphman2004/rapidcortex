...
| **Certified** CJIS, HIPAA, SOC 2 Type II, FedRAMP (or any attestation you cannot show) | [SECURITY_MODEL.md](../security-compliance/SECURITY_MODEL.md), [soc2/README.md](../security-compliance/soc2/README.md), [PROMISE_CONTROL.md](./PROMISE_CONTROL.md) §2 |
| **Guaranteed** AI accuracy, latency, or multilingual quality | [KNOWN_LIMITATIONS.md](../product-architecture/KNOWN_LIMITATIONS.md) |
| “**All** languages” or interpreter **elimination** | [SALES_BOUNDARIES.md](./SALES_BOUNDARIES.md) §4 |
| **Universal** vendor-certified CAD integration “included” | [INTEGRATIONS_CAD_AND_MOTOROLA.md](../product-architecture/INTEGRATIONS_CAD_AND_MOTOROLA.md) |
...
| **MFA authenticators** | Agencies own TOTP device possession (CUEC) on the production Cognito pool |
...
- Medical/tactical **authority** requires protocol pack backing and agency review—not raw LLM improvisation ([PROTOCOL_REVIEW_REQUIREMENTS.md](../security-compliance/PROTOCOL_REVIEW_REQUIREMENTS.md)).
...
- **Fixed in product architecture:** RBAC shape, tenant isolation approach, core API semantics, **production MFA ON**.  
...
Anything marked future / planned in [FEATURE_MATRIX.md](../product-architecture/FEATURE_MATRIX.md) or [PILOT_VS_FUTURE_STATE.md](./PILOT_VS_FUTURE_STATE.md) is **not** a pilot deliverable until release + docs are updated.
