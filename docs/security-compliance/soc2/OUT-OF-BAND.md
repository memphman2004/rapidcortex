...
| SOC-106 | Execute restore drill (new table) | Eng | **Yes** | **DRY_RUN DONE**; live restore needs AWS |
| SOC-107 | Monthly live observation packs | Eng | **Yes** | **PARTIAL** hashed 2026-10 pack; live CLI blocked |
