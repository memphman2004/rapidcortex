...
|----|------|--------|------------|------------|-------|--------|
| R-SOC-001 | Shared AWS account hosts other products | High (scope dispute) | Med | Carve-out in [SYSTEM-BOUNDARY.md](../SYSTEM-BOUNDARY.md); NexCort iQ naming; dedicated account later | Management | **Accepted** for first window |
...
| R-SOC-011 | Entity naming AOD vs NexCort iQ LLC | Med | High | LEG-007 | Legal | Open |
