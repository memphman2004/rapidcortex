...
| 5b | Restore drill | **LIVE RESTORE REQUESTED** — table `rapid-cortex-audit-dev-restore-20260919` was CREATING. Wait ACTIVE, validate, delete the copy (not production). | [07-live-mac-mini.md](./07-live-mac-mini.md) |
...
**Next on Jeffs-Mac-mini:** wait until restore table is ACTIVE, validate counts, delete `rapid-cortex-audit-dev-restore-20260919` only, then `git add docs/evidence/soc2-evidence/2026-09 && git commit && git push`.
