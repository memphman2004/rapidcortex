...
- **A2P 10DLC registration:** required for **`+14707482763`**. Brand and campaign must be approved **and the number assigned to the campaign** before production sends. Use **only** for the registered Rapid Cortex use case: dispatcher-initiated, incident-specific SMS/MMS to people who contacted 911/public safety and gave consent — **not** marketing, demos-at-scale, newsletters, or general sales outreach.
