...
export const metadata = { title: "Automated invoices — Rapid Cortex Admin", robots: { index: false, follow: false } };
...
export default async function AutomatedInvoicesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <p className="text-xs font-medium uppercase tracking-widest text-slate-500">RC Internal</p>
