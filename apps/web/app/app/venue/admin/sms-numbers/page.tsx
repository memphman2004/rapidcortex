...
export const metadata = {
  title: "SMS Numbers (Venue Admin)",
  robots: { index: false, follow: false },
};

export default async function VenueAdminSmsNumbersPage() {
    ...
    <div className="mx-auto max-w-4xl space-y-4 px-4 py-8">
      <div>
        ...
        <div className="mt-4 flex flex-wrap gap-4 text-sm">
          <Link href="/app/venue/admin/qr-codes" className="text-sky-400 hover:text-sky-300">
            ← QR codes
          </Link>
        </div>
      </div>
