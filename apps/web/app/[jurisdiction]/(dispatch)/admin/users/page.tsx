  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <p className="mt-1 max-w-2xl text-sm text-slate-400">
        User directory for your agency. Create users with a temporary password; first sign-in follows your
        agency password policy (password change and MFA when required).
      </p>
