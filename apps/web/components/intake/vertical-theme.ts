...
export const VERTICAL_THEME = {
  campus: {
    ...
    pillText: "#334155",
    labelColor: "#475569",
    focusRing: "rgba(100,116,139,0.16)",
    anonChecked: "#64748b",
    securityBg: "#f1f5f9",
    securityBorder: "#cbd5e1",
    securityText: "#334155",
    securityIcon: "#64748b",
  ...
  venue: {
    ...
    primaryHover: "#ea580c",
    primaryText: "#ffffff",
    pillSelected: "rgba(249,115,22,0.08)",
    pillBorder: "#f97316",
    pillText: "#fb923c",
    labelColor: "#f97316",
    focusRing: "rgba(249,115,22,0.12)",
    anonChecked: "#f97316",
    securityBg: "rgba(249,115,22,0.08)",
    securityBorder: "rgba(249,115,22,0.25)",
    securityText: "#fdba74",
    securityIcon: "#fb923c",
    emergencyText: "#f87171",
    headerSubtext: "#f97316",
    footerBg: "#060d1a",
    footerBorder: "#1e293b",
    inputBg: "#111827",
    inputBorder: "#334155",
