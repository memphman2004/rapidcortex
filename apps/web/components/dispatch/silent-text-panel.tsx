...
export function SilentTextPanel({
  ...
  return (
    <div className={embedded ? "p-3" : "rounded-lg border border-slate-800 bg-slate-950/50 p-3"}>
      {!embedded ? (
        ...
        <>
          ...
          <button
            ...
            className="mt-3 w-full rounded-md bg-violet-700 px-2 py-2 text-xs font-medium text-white hover:bg-violet-600"
          >
            Send Silent Text Link
          </button>
        </>
