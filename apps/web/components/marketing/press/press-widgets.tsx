...
export const PRESS_BOILERPLATE =
  "NexCort iQ is a real-time AI intelligence platform for public safety agencies and a product of Apps on Demand, founded in 2025. The platform provides 911 dispatchers and supervisors with live transcription, AI-generated incident summaries, and CAD system integration — designed to CJIS security standards. NexCort iQ is available as a web platform, desktop application, and API. For press inquiries, contact info@nexcortiq.us. For more information, visit rapidcortex.us.";
