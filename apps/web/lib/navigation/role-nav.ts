  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "sales-automation", label: "Sales Automation", href: "/rc-admin/sales-automation", icon: "Mail", feature: "salesAutomation" },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "cad-connector", label: "CAD Connector",   href: `${j}/cad/connectors`, icon: "Radio",
            feature: "cadConnector" },
...
export function getCampusAdminNav(code: string): RoleNav {
  ...
  return {
    ...
    sections: [
      ...
      {
        id: "clery-compliance",
        label: "CLERY COMPLIANCE",
        items: [
          {
            id: "clery-review",
            label: "Review Queue",
            href: `${base}/clery/review`,
            icon: "ClipboardCheck",
            feature: "cleryModule",
          },
          {
            id: "clery-dcl",
            label: "Daily Crime Log",
            href: `${base}/clery/daily-crime-log`,
            icon: "BookOpen",
            feature: "cleryModule",
          },
          {
