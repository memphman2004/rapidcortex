...
describe("isCommsPlatformApiPath", () => {
  ...
  it("matches campus prefix (stack 5)", () => {
    ...
    expect(isSam5ApiPath("/api/media/live/tok/join")).toBe(true);
    expect(isSam5ApiPath("/api/media/live/tok/heartbeat")).toBe(true);
  ...
  it("routes Call Assist to stack 2 only", () => {
    ...
    expect(isStack2ApiPath("/api/vision/scene-stats")).toBe(true);
  ...
  it("routes CAD Bridge to stack 2 only", () => {
    ...
    expect(isStack2ApiPath("/api/agencies/kcpd/network")).toBe(true);
    expect(isStack2ApiPath("/api/agencies/kcpd/network/shared-incidents")).toBe(true);
