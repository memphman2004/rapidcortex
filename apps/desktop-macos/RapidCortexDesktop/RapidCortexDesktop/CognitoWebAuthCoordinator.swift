...
extension CognitoWebAuthCoordinator.CognitoAuthError: LocalizedError {
    var errorDescription: String? {
        ...
        case .missingWebAppBaseURL:
            return "Add WEB_APP_BASE_URL or NEXT_PUBLIC_SITE_URL to Secrets.plist (your NexCort iQ website origin, e.g. https://app.rapidcortex.us). Sign-in opens that site in your browser, then returns to the app."
        case .badAuthorizeURL:
