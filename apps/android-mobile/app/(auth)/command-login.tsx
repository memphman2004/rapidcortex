  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      if (!isCommandRole(role)) {
        await signOut();
        setFieldError(Strings.auth.errors.commandAccessDenied);
        return;
      }
      await useAuthStore.getState().setProductPath('command');
...
export default function CommandLoginScreen() {
  return (
