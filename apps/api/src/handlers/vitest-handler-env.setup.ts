...
process.env.ENABLE_C2C_HUB ??= "true";
process.env.C2C_AGENCIES_TABLE ??= "test-c2c-agencies";
process.env.C2C_INCIDENTS_TABLE ??= "test-c2c-incidents";
process.env.C2C_AUDIT_TABLE ??= "test-c2c-audit";
process.env.C2C_RULES_TABLE ??= "test-c2c-rules";
process.env.C2C_AVL_TABLE ??= "test-c2c-avl";
...
process.env.ENABLE_AUTOMATED_INVOICES ??= "true";
process.env.AUTO_SEND_INVOICES ??= "false";
process.env.AUTOMATED_INVOICES_TABLE ??= "test-automated-invoices";
process.env.AGENCY_BILLING_CONFIGS_TABLE ??= "test-agency-billing-configs";
process.env.USAGE_SNAPSHOTS_TABLE ??= "test-usage-snapshots";
process.env.BILLING_RUNS_TABLE ??= "test-billing-runs";
