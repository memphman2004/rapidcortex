...
process.env.FIELD_COMMAND_TABLE ??= "test-field-command";
process.env.CALL_ASSIST_TABLE ??= "test-call-assist";
process.env.CAD_BRIDGE_CONFIG_TABLE ??= "test-cad-bridge-config";
process.env.CAD_BRIDGE_SYNC_TABLE ??= "test-cad-bridge-sync";
process.env.CAD_BRIDGE_LOOP_GUARD_TABLE ??= "test-cad-bridge-loop-guard";
process.env.CAD_BRIDGE_CB_TABLE ??= "test-cad-bridge-cb";
process.env.CAD_BRIDGE_BUFFER_TABLE ??= "test-cad-bridge-buffer";
process.env.CAD_BRIDGE_AUDIT_TABLE ??= "test-cad-bridge-audit";
process.env.CAD_BRIDGE_QUEUE_URL ??= "https://sqs.us-east-1.amazonaws.com/1/cad-bridge.fifo";
process.env.ENABLE_CAD_BRIDGE ??= "true";
process.env.CAD_BRIDGE_MOCK ??= "true";
process.env.ENABLE_CALL_ASSIST ??= "true";
process.env.CALL_ASSIST_LEX_BEDROCK_MOCK ??= "1";
process.env.ENABLE_CALL_ASSIST_CAD_PUSH ??= "false";
...
process.env.INCIDENT_REPORTS_TABLE ??= "test-incident-reports";
process.env.ESCALATIONS_TABLE ??= "test-escalations";
process.env.ESCALATION_AUDIT_TABLE ??= "test-escalation-audit";
process.env.AGENCY_RELATIONSHIPS_TABLE ??= "test-agency-relationships";
...
process.env.RING_CAMERA_REQUESTS_TABLE ??= "RingEmergencyCameraRequests-test";
process.env.HOMEOWNER_PENDING_TABLE ??= "RingEmergencyCameraRequests-test";
process.env.RING_TABLE_HOMEOWNER_PARTICIPANTS ??= "RapidCortexRingHomeownerParticipants-test";
process.env.HOMEOWNER_TABLE ??= "RapidCortexRingHomeownerParticipants-test";
process.env.COGNITO_CLIENT_ID ??= "test-cognito-client";
