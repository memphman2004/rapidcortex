  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: palette.background }} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing['5'], paddingBottom: spacing['10'] }}>
        ...
        <Card onPress={() => router.push(href(`/code/${code.codeId}/nfc-write`) as never)} style={{ marginBottom: spacing['3'] }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            <View>
        ...
        <Card onPress={() => router.push(href(`/code/${code.codeId}/qr-view`) as never)} style={{ marginBottom: spacing['5'] }}>
