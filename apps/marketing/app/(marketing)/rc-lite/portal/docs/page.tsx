...
export const metadata = { title: "NexCort Lite — docs", robots: { index: false, follow: false } };
  ...
  return (
    <div>
      ...
      <p className="mt-3 text-sm leading-relaxed text-slate-400">
        Operational documentation aligns with developer guides for the NexCort iQ Agency REST API.
      </p>
