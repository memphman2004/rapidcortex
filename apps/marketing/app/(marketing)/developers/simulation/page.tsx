...
export const metadata = {
  title: "NexCort Lite — Sandbox simulation catalogue",
};
  ...
  return (
    <MarketingArticleShell eyebrow="Demos & grants" title="Simulation payloads" sectionLabel="Developers">
      <p className="leading-relaxed text-slate-200">
        NexCort Lite exposes deterministic sandbox fixtures mirroring ECC stress patterns—grant writers, PIO demos, onboarding
