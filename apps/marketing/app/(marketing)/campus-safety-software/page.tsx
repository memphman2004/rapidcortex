...
export const metadata: Metadata = buildPublicPageMetadata({
  title: "Campus Safety Software for Universities | NexCort iQ",
  description:
...
export default function CampusSafetySoftwarePage() {
  return (
    <KeywordLandingPage
      ...
      intro="NexCort iQ Campus is a university safety platform that helps campus police, public safety, and emergency management coordinators receive structured reports faster. It enhances existing campus operations. It does not replace campus police, 911, or medical direction."
      sections={[
        {
        ...
        },
        {
          ...
          body: "NexCort iQ Campus adds a low-friction reporting and coordination layer on top of the teams and systems you already run.",
          bullets: [
        ...
        },
        {
          ...
          body: "Campus deployments are scoped for Clery-aware documentation, role-based access, and retention policies the institution configures. NexCort iQ records who accessed what and when. It does not file Clery statistics or replace your Clery coordinator.",
        },
        {
          title: "What NexCort iQ does not replace",
          body: "Campus police, municipal 911, emergency notification systems, and medical direction stay in place. NexCort iQ is decision-support and incident intake — not a substitute for trained responders or statutory reporting offices.",
        },
      ]}
      relatedLinks={[
      ...
      faq={[
        {
          ...
          answer:
            "No. NexCort iQ Campus enhances campus safety operations. It does not replace campus police, municipal 911, or medical direction.",
        },
        {
          question: "What integrations does NexCort iQ Campus support?",
          answer:
